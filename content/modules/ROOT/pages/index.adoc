...
The terminal window to your right has the `oc` command we will use during the lab already installed. Let's test it by running the following command:
...
Run this command to set the current project to 'default'. 
